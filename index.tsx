...
// Data Layanan (Modul 2)
const SERVICES = [
  { id: '1', title: 'Gentleman Haircut', price: 'Rp 50.000', icon: 'content-cut' },
  { id: '2', title: 'Hair Treatment', price: 'Rp 35.000', icon: 'water-drop' },
...
export default function CombinedApp() {
  ...
  return (
    <SafeAreaView style={styles.containerCatalog}>
      ...
      {/* Footer identitas tipis di bawah */}
...
const styles = StyleSheet.create({
  ...
  // Styles untuk Katalog (Modul 2)
  containerCatalog: { flex: 1, backgroundColor: '#1e3a8a' },
  headerCatalog: { padding: 25, flexDirection: 'row', alignItems: 'center', backgroundColor: '#1e40af' },
